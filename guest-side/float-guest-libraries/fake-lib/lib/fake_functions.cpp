...
__host__ cudaError_t CUDARTAPI cudaMemcpy(void *dst, const void *src, size_t count, enum cudaMemcpyKind kind){
    ...
    //printf("time rec : %f\n", time_spent);
        ...
        case cudaMemcpyDeviceToHost:
            ...
            if (respError != cudaSuccess)
                return respError;
            //printf("value : %d\n", *((uint8_t*)msg_p+sizeof(struct cudaMemcpyStruct)));
...
/*__host__ __device__ cudaError_t CUDARTAPI cudaFuncGetAttributes (cudaFuncAttributes* attr, const void* func)
{
	cudaError_t respError = cudaErrorApiFailureBase;
}*/
...
__host__ cudaError_t CUDARTAPI cudaFuncSetCacheConfig ( const void* func, cudaFuncCache cacheConfig )
{
	cudaError_t respError = cudaErrorApiFailureBase;
printf("cudaFuncSetCacheConfig\n");
}

__host__ cudaError_t CUDARTAPI cudaFuncSetSharedMemConfig ( const void* func, cudaSharedMemConfig config ) 
{
	cudaError_t respError = cudaErrorApiFailureBase;
printf("cudaFuncSetSharedMemConfig\n");
}

__device__ void* CUDARTAPI cudaGetParameterBuffer ( size_t alignment, size_t size ) 
{
	cudaError_t respError = cudaErrorApiFailureBase;
...
__device__ void* CUDARTAPI cudaGetParameterBufferV2 ( void* func, dim3 gridDimension, dim3 blockDimension, unsigned int  sharedMemSize )
{
	cudaError_t respError = cudaErrorApiFailureBase;
...
//__host__ cudaError_t CUDARTAPI cudaLaunchCooperativeKernelMultiDevice ( cudaLaunchParams* launchParamsList, unsigned int  numDevices, unsigned int  flags = 0 )
//{
//	cudaError_t respError = cudaErrorApiFailureBase;
//}
