...
case facu__cudaUnregisterFatBinary:
...
case facu__cudaRegisterFunction:
...
case facuDeviceComputeCapability:
...
case facuMemHostGetDevicePointer:
...
case facuGraphicsUnregisterResource:
...
case facuGraphicsSubResourceGetMappedArray:
...
case facuGraphicsResourceGetMappedPointer:
...
case facuGraphicsResourceSetMapFlags:
...
case facuGraphicsUnmapResources:
...
case facudaDeviceGetCacheConfig:
...
case facudaDeviceSetCacheConfig:
...
case facudaThreadGetCacheConfig:
...
case facudaThreadSetCacheConfig:
...
case facudaGetDeviceProperties:
...
case facudaEventCreateWithFlags:
...
case facudaHostGetDevicePointer:
...
case facudaPointerGetAttributes:
...
case facudaDeviceCanAccessPeer:
...
case facudaDeviceEnablePeerAccess:
...
case facudaDeviceDisablePeerAccess:
...
case facudaGraphicsUnregisterResource:
...
case facudaGraphicsResourceSetMapFlags:
...
case facudaGraphicsResourceGetMappedPointer:
...
case facudaGraphicsSubResourceGetMappedArray:
...
case facudaGetTextureAlignmentOffset:
...
case facudaGetTextureReference:
...
case facudaGetSurfaceReference:
